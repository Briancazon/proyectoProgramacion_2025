...
public class eliminarPreventista extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        labelDniPreventista = new javax.swing.JLabel();
        ...
        labelDniPreventista.setText("jLabel3");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGap(126, 126, 126)
                .addComponent(labelDniPreventista)
    ...
    private void botonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEliminarActionPerformed
         ...
         int respuesta = JOptionPane.showConfirmDialog( null, "¿Estás seguro de que deseas eliminar a este preventista?", "Confirmar eliminación", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE );
         
        if (respuesta == JOptionPane.YES_OPTION){
          int dni= Integer.parseInt(labelDniPreventista.getText());
          try{
    ...
    private void tablaPreventistaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaPreventistaMouseClicked
       try{
            ...
            labelDniPreventista.setText(dni);
            activarEliminar();
    ...
    private javax.swing.JLabel labelDniPreventista;
